CLASS zcl_gener_travel_data_denis_2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_gener_travel_data_denis_2 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_denis_2.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_denis_2.

*   insert the new table entries
    INSERT ztravel_denis_2 FROM TABLE @itab.
